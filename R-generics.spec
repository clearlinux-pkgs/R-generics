...
Version  : 0.0.1
Release  : 1
URL      : https://cran.r-project.org/src/contrib/generics_0.0.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/generics_0.0.1.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1542922075
